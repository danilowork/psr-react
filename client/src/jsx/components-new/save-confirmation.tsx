...
@observer
class SaveConfirmation extends Component<SaveConfirmationProps, {}> {
  ...
  render() {
    ...
    return (
      ...
      <div className={"reveal save-confirmation " + (this.props.userType || '')}
           id="save-confirmation"
           data-reveal data-animation-in="fade-in fast"
