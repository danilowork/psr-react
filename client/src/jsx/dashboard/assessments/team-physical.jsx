...
class PhysicalAss extends Component {
  ...
  onCancel = () => {
    ...
    this.props.history.push(`/dashboard/directory/team-management/${this.props.match.params.t_id}/physical-competence`);
  }
  ...
  setCategory = (category) =>{
    ...
    history.replaceState(null, "", `/dashboard/directory/team-management/${this.props.match.params.t_id}/physical-competence/new-assessment/${this.props.match.params.a_id}/${this.curDef.id}`);
  }
