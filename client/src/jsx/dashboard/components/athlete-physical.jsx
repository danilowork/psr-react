...
export default inject('user', 'assDefs', 'assessments')(observer(class extends Component {
      ...
      const disposer = observe(this,
                               ...
                               change => {
                                 if (change.newValue.length) {
                                   this.curCategory = 'Physical Skills';//this.physicalDefs[0].name;
                                   disposer();
                                 }
  ...
  newAssUrl = () => {
    ...
    if (this.props.match.params.t_id) {
      ...
      return `/dashboard/directory/team-management/${this.props.match.params.t_id}/physical-competence/new-assessment/${this.props.match.params.a_id}/${this.curCategoryId}`
    } else {

      return `/dashboard/physical-competence/new-assessment/${this.curCategoryId}/${this.props.match.params.a_id}`;
    }
  }
